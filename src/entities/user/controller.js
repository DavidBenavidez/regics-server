          ...
          if(row3.length < 3){
            ...
            db.query(advisersString, (err, row) => {
                ...
                for(var i = 0; i < row.length; i++){
                  if(!containsObject({empno: row[i].empno},advisersArray)) advisersArray.push({empno: row[i].empno});
                }
                ...
                for(var i = 0; i < row.length; i++){
                  for(var j = 0; j < advisersArray.length; j++){
                    if(row[i].empno == advisersArray[j].empno) count[j] = count[j] + 1;   
                  }
                }
                ...
                db.query(queryString2, (err2, row2) => {
                  ...
                  for(var i = 0; i < count.length; i++){
                    if(count[i] < minValue3 && count[i] > minValue1 && count[i] > minValue2){
                      minValue3 = count[i];
                      minIndex3 = i;
                    }
                  }
                  ...
                  for(var counter2 = 0; counter2 < row3.length; counter2++){
                    if(row3[counter2].empno == advisersArray[minIndex3].empno){
                      recommendedAdvisers.push({empno: row3[counter2].empno, name: row3[counter2].name });
                    }
